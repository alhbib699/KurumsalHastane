    ...
    public class AppointmentController : Controller
    {
        ...
        public async Task<ActionResult> List()
        {
            ...
            foreach (var appointment in appointemnts)
            {
                ...
                appointmentModel.PatientName = appointment.Patient.FirstName + " " + appointment.Patient.LastName;
                appointmentModel.SpecialistName = appointment.Specialist.FirstName + " " + appointment.Specialist.LastName;
